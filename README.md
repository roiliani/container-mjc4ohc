...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-mjc4ohc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-mjc4ohc.containers.anotherwebservice.com/
...
```
git clone git@github.com:roiliani/container-mjc4ohc.git
cd container-mjc4ohc
```
...
```
docker attach container-mjc4ohc
```
